...
level0_filename = "hermes_SPANI_l0_2022339-000000_v0.bin"
level1_filename = "hermes_spn_l1_20221205T000000_v1.0.0.cdf"
ql_filename = "hermes_spn_ql_20221205T000000_v1.0.0.cdf"
...
def test_calibrate_file_nofile_error():
    ...
    with pytest.raises(FileNotFoundError):
        calib.calibrate_file(Path("hermes_SPANI_l0_2032339-000000_v0.bin"))


def test_process_file_nofile_error():
    """Test that if file does not exist it produces the correct error. The file needs to be in the correct format."""
    with pytest.raises(FileNotFoundError):
        calib.process_file(Path("hermes_SPANI_l0_2032339-000000_v0.bin"))
