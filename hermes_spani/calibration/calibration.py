...
import hermes_spani
from hermes_spani.io import load_data_file, read_calibration_file, write_data_file
...
def calibrate_data(instrument_data: HermesData) -> HermesData:
    ...
    Examples
    --------
    >>> from hermes_spani.io import load_data_file
    >>> from hermes_spani.calibration import calibrate_data
    >>> level_0_data = load_data_file('hermes_SPANI_l0_2022239-000000_v0.bin') # doctest: +SKIP
